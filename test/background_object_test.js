...
describe('BackgroundObject', function(){
  context('with given attributes', function(){
    var backgroundObject = new BackgroundObject({source: 'backgroundObject.png', x: 50, y: 300, width: 150, height: 250});
    ...
    it('should have an img', function(){
      ...
      assert.equal(backgroundObject.img.src, 'backgroundObject.png');
    });
