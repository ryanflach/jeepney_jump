...
const touchedCanvas = (touchEvent) => {
  ...
  return (
    touchEvent.pageX >= startX &&
    touchEvent.pageX <= endX &&
    touchEvent.pageY >= startY &&
    touchEvent.pageY <= endY
  );
};
...
const registerServiceWorker = () => {
  if ('serviceWorker' in navigator) {
    navigator.serviceWorker.register('/jeepney_jump/lib/service_worker.js')
    .then(function(reg) {
      // registration worked
