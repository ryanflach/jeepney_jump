...
var Game = function(canvas, context){
  ...
  this.backgroundObjects = [new BackgroundObject({ x: this.size.x, y: 167, width: 53.75, height: 135, imgSrc: '/assets/images/palm_tree.png' })];
...
Game.prototype.generateBackgroundObjects = function(){
  ...
  if (firstbackgroundObject.x < 0 - firstbackgroundObject.width) {
    ...
    this.backgroundObjects.push(new BackgroundObject({ x: this.size.x, y: 167, width: 53.75, height: 135, imgSrc: '/assets/images/palm_tree.png' }));
  }
};
